...
1. Configuration
1. You need to confirm whether all the above stuff are started;
1. Use the editor to open the public folder, the global search for the contents of ‘iot.beaconyun.com’, replace it with your IP address or domain name. And then copy all the documents under the public to root directory by nginx.conf, visit IP or domain name can open on the line;
1. Configure the mysql database, build user and give the password.
